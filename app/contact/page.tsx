        ...
        <div className="bg-white p-8 md:p-10 rounded-3xl border border-[#111111]/10 shadow-sm mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <a
              ...
              className="p-4 rounded-2xl bg-[#F6F5ED] border border-[#111111]/5 hover:border-[#0A66C2] hover:bg-white transition-all flex flex-col items-center text-center gap-2 group"
            >
              ...
              <span className="font-medium text-sm text-[#111111]">LinkedIn</span>
              <span className="text-xs text-[#111111]/50 font-mono">Company</span>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-4 rounded-2xl bg-[#F6F5ED] border border-[#111111]/5 hover:border-black hover:bg-white transition-all flex flex-col items-center text-center gap-2 group"
            >
              <div className="w-10 h-10 rounded-full bg-black/10 text-black flex items-center justify-center group-hover:scale-110 transition-transform">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              <span className="font-medium text-sm text-[#111111]">GitHub</span>
              <span className="text-xs text-[#111111]/50 font-mono">Open Source</span>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-4 rounded-2xl bg-[#F6F5ED] border border-[#111111]/5 hover:border-[#E1306C] hover:bg-white transition-all flex flex-col items-center text-center gap-2 group"
            >
              <div className="w-10 h-10 rounded-full bg-[#E1306C]/10 text-[#E1306C] flex items-center justify-center group-hover:scale-110 transition-transform">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              <span className="font-medium text-sm text-[#111111]">Instagram</span>
            ...
            >
              ...
              <span className="font-medium text-sm text-[#111111]">X (Twitter)</span>
              <span className="text-xs text-[#111111]/50 font-mono">@loomenflylabs</span>
            </a>
          </div>
        </div>
